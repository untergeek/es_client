...
def run(
    ...
    # The ``cfg.generate_configdict`` function does all of the overriding of YAML config file options
...
# Normally, for a sub-command, you would not reset the `cfg.context_settings` as we've done here
